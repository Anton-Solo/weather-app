...
export const SearchItem = ({weather}: WeatherProps) => {
        ...
        <Card>
            <Box sx={{display:'flex', flexDirection: {xs: 'column', sm: 'row'}}}>
                ...
                <CardContent>
                    ...
                    <Typography variant="h6">
                        <span style={{color: '#1976d2'}}>About:</span> {weather.weather[0].description}
                    </Typography>
                </CardContent>
                <CardContent>
                    <Typography variant="h6">
                        <span style={{color: '#1976d2'}}>Max:</span> {String(weather.main.temp)[0] === '-' ? Math.floor(weather.main.temp_max) : '+' + Math.floor(weather.main.temp_max)}
                    </Typography>
                    <Typography variant="h6">
                        <span style={{color: '#1976d2'}}>Min:</span> {String(weather.main.temp)[0] === '-' ? Math.floor(weather.main.temp_min) : '+' + Math.floor(weather.main.temp_min)}
                    </Typography>
                </CardContent>
                <CardContent>
                    <Typography variant="h6">
                        <span style={{color: '#1976d2'}}>Wind speed:</span> {Math.floor(weather.wind.speed)}
                    </Typography>
                    <Typography variant="h6">
                        <span style={{color: '#1976d2'}}>Wind deg:</span> {Math.floor(weather.wind.deg)}
                    </Typography>
                </CardContent>
            </Box>
            <CardActions>
                ...
                <Button>
                    <Link to={weather.name} style={{color: 'inherit', textDecoration: 'none'}}>
                        Show more
                    </Link>
                </Button>
            </CardActions>
