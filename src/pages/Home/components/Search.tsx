...
export const Search = () => {
    ...
    const handleSearch: React.ChangeEventHandler<HTMLTextAreaElement | HTMLInputElement> = (e) => {
    ...
    return (
        <>
            ...
            { weather && response.status === 200 ? <SearchItem weather={weather}/> : <h2>not found</h2>} 
        </>
    )
}